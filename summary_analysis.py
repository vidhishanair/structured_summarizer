...
def get_avg_sent_copied(article_dir, summary_dir):
    ...
    for article in tqdm(article_files):
        ...
        seen_sent, art_len, avg_max_seq_len = get_sent_dist(summary, article_sents)
    ...
    return avg_percentage, avg_nosents, avg_max_seq_len_tot
...
if __name__ == '__main__':
    ...
    baseline_avg_percent, baseline_avg_nosents, avg_seq_len = get_avg_sent_copied(article_dir, baseline_dir)
    print("Doing pointgen")
    pointgen_avg_percent, pointgen_avg_nosents, avg_seq_len = get_avg_sent_copied(article_dir, pointgen_dir)
    print("Doing coverage")
    pointgen_cov_avg_percent, pointgen_cov_avg_nosents, avg_seq_len= get_avg_sent_copied(article_dir, pointgen_cov_dir)

    # Write to file.
    with open(out_file_path, 'w') as out_file:
        out_file.write("Baseline: "+str(baseline_avg_nosents)+" "+str(baseline_avg_percent) + " " + str(avg_seq_len))
        out_file.write("Pointgen: "+str(pointgen_avg_nosents)+" "+str(pointgen_avg_percent) + " " + str(avg_seq_len))
        out_file.write("Pointgen_Cov: "+str(pointgen_cov_avg_nosents)+" "+str(pointgen_cov_avg_percent) + " " + str(avg_seq_len))

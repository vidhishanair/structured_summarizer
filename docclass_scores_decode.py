...
class BeamSearch(object):
    def __init__(self, args, model_file_path, save_path, class_reload_path):
        ...
        with open(class_reload_path, 'rb') as f:
            self.classifier_model = torch.load(f)
    ...
    def beam_search(self, batch, count):
        ...
        feed_dict = {'token_idxs': enc_batch,
                     ...
                     'sent_l': enc_sent_lens,
                     'doc_l': enc_doc_lens}

        output, sent_attention_matrix, doc_attention_matrix = self.classifier_model.forward(feed_dict)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--class_reload_path', type=str, default=None, help='location of the older saved path')
    ...
    class_reload_path = args.class_reload_path
    beam_Search_processor = BeamSearch(args, model_filename, save_path, class_reload_path)

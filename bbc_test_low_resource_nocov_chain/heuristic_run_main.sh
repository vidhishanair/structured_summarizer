...
OUTPUT='bbc_test_low_resource_nocov_chain'
...
CUDA_VISIBLE_DEVICES=0 python main.py \
       ...
       --batch_size 8 \
       --max_dec_steps 100 \
       --reload_path=log/${OUTPUT}/model/model_17000_1575613973 \
...
#       --reload_path=log/sent_level_tag_coverage/model/model_17000_1575613973 \

...
CUDA_VISIBLE_DEVICES=0 python main.py \
       ...
       --batch_size 8 \
       --max_dec_steps 20 \
       --train_data_path=../artidoro-cnn-dailymail/finished_files_wlabels_wner_wcoref_chains_reduced_1/chunked/train_* \
       --eval_data_path=../artidoro-cnn-dailymail/finished_files_wlabels_wner_wcoref_chains_reduced_1/val.bin \
       --vocab_path=../artidoro-cnn-dailymail/finished_files_wlabels_wner_wcoref_chains_reduced_1/vocab \
       --use_summ_loss \
       # --heuristic_chains \
       # --use_coref \

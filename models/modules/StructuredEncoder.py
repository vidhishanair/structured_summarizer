...
class StructuredEncoder(nn.Module):
    ...
    def forward_test(self, input, sent_l, doc_l, tokens_mask, sent_mask, word_batch, word_padding_mask, enc_word_lens, enc_tags_batch):
        ...
        token_score = self.token_pred_linear(tk)
